...
class Roll(models.Model):
    ...
    color = models.ForeignKey(Color, on_delete=models.CASCADE, related_name='+', null=True, blank=True)
    kg = models.DecimalField(max_digits=5, decimal_places=2, default=0.00)
    batch = models.ForeignKey(Batch, on_delete=models.CASCADE, default=None, related_name='roll')
